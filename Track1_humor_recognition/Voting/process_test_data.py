...
train_dir='/aliyun-06/share_v2/yangshiping/projects/humor_computation/final_dataset/dataset/task1_test'
save_path = '../data/final_task1_test.json'
...
def organize_data(filepath):
    ...
    with open(filepath) as csvfile:
        ...
        col_name = ['id','Sentence', 'Speaker']    #我们需要的列
        header_dic = {}
