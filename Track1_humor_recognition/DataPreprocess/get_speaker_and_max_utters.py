...
train_dir='../task1验证集'
save_path = '../use_data/full_dev.json'
speaker_path = '../use_data/charlie_speaker.json'
...
def main():
    ...
    # speaker2id = {}
    # for speaker in train_speaker_set:
    #     speaker2id[speaker] = len(speaker2id)


    # with open(speaker_path,"w") as w:
    #     json.dump(speaker2id,w)
...
# dialogue_len = []                   #最长的对话有162句，最短的只有8句
# for dialogue in all_data:
#     dialogue_len.append(len(dialogue))

# print(len(speaker_set))      #总共出现了259个说话人
